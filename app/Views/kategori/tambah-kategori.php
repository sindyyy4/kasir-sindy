    ...
    <div class="card-body">
      ...
      <form class="row g-3"  action="<?=site_url('simpan-kategori');?>" method="POST">
        <div class="col-12">
          ...
          <input type="text" class="form-control" id="inputJenis" name="nama_kategori" required name="kategori_produk" placeholder="Masukan Kategori Produk" autofocus autocomplete="off">
